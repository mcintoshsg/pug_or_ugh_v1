...
class Dog(models.Model):
    ...
    size = models.CharField(
        max_length=2,
        help_text='size; Enter, (s) Small, (m) Medium, (l) Large, (xl) Extra Large'
        )
...
class UserPref(models.Model):
    ...
    user = models.OneToOneField(User,
        ...
        help_text='Can only have one set of prefrences per user',
        null=True
        )
    age = models.CharField(
        max_length=10,
        help_text = ('age; Enter, (b) Baby, (y) Young, (a) Adult,'
                        ' (s) Senior or a combaination seperated by a comma.')
    )
    gender = models.CharField(
        max_length=10,
        help_text = ('gender; Enter, (m) Male, (f) Female,'
                        ' (s) Senior or a combaination seperated by a comma.')
    )                    
    size = models.CharField(
        max_length=10,
        help_text = ('size; Enter, (s) Small, (m) Medium, (l) Large, (xl) Extra Large'
                        ' or a combination seperated by a comma.')
    )
